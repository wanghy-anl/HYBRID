...
public
  ...
  Modelica.Blocks.Sources.Constant const2(k=12.6)
    annotation (Placement(transformation(
        ...
        rotation=0,
        origin={162,-190})));
  Modelica.Blocks.Interfaces.RealOutput TC_003_Temp annotation (Placement(
        transformation(extent={{180,-6},{204,18}}), iconTransformation(extent={{
            128,68},{152,92}})));
  Modelica.Blocks.Interfaces.RealOutput TC_201_Temp annotation (Placement(
        transformation(extent={{180,-26},{204,-2}}), iconTransformation(extent={
            {128,68},{152,92}})));
  Modelica.Blocks.Interfaces.RealOutput Glycol_Exit_Temp annotation (Placement(
        transformation(extent={{180,-46},{204,-22}}), iconTransformation(extent
          ={{128,68},{152,92}})));
